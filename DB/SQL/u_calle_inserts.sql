...
VALUES (2403112, 'Gregorio', 'Soteldo', '1990-01-17', 'M', 'gregogrio.soteldo@ucalle.edu.co', 
...
INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (1264457, 'Antonia', 'Rodriguez', '1985-06-13', 'F', 'antonia.rodriguez@ucalle.edu.co', 
...
INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (3921028, 'Mariana', 'Rosario', '1999-02-19', 'F', 'mariana.rosario@ucalle.edu.co', 
       'Cra 1 # 10-16', 3024832013, 'VEN', 'marianarb', SHA('semeolvido2021'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (8674843 'Nicolas', 'Quintero', '2001-05-03', 'M', 'nicolas.quintero@ucalle.edu.co', 
       'Dig 25 # 12-09', 3046859271, 'COL', 'nicolasqp', SHA('nicolasq21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (3230911, 'Aurimar', 'Suarez', '1997-10-27', 'F', 'aurimar.suarez@ucalle.edu.co', 
       'Cll 30 # 30-02', 3103493121, 'VEN', 'aurimarst', SHA('aurimars21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (5388785, 'Kevin', 'Perdomo', '2000-12-08', 'M', 'kevin.perdomo@ucalle.edu.co', 
       'Cra 56 # 12-21', 3156936353, 'COL', 'kevinjp', SHA('kevinp21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (4346337, 'Valeria', 'Padilla', '2002-07-21', 'F', 'valeria.padilla@ucalle.edu.co', 
       'Cra 56 # 12-22', 3158727567, 'COL', 'valeriapp', SHA(' valeriap21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (4781242, 'Snaider', 'Pardo', '1998-08-31', 'M', 'snaider.pardo@ucalle.edu.co', 
       'Cra 30 # 33-33', 3226153354, 'COL', 'snaiderpq', SHA('snaiderp21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (6563465, 'Monica', 'Materano', '1997-08-20', 'F', 'monica.materano@ucalle.edu.co', 
       'Cra 80 # 70-16', 3123979419, 'VEN', 'monicamc', SHA('monicam21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (1976918, 'Tatiana', 'Caracas', '1997-11-15', 'F', 'tatiana.caracas@ucalle.edu.co', 
       'Cra 80 # 60-20', 3122795666, 'COL', 'tatianacv', SHA('tatianac21'), '2021-05-24');

INSERT INTO `u_calle`.`Persona`
              (`id_persona`, `nombre`, `apellido`, `fech_nac`, `genero`, `correo`, `direccion`, 
              `celular`, `nacionalidad`, `nom_usuario`, `contrasena`, `creado_en`)
VALUES (3983655, 'Andres', 'Flores', '2003-12-21', 'M', 'andres.flores@ucalle.edu.co', 
...
VALUES (502, 'HIST', 2403112, 1);

INSERT INTO `u_calle`.`Profesor`
              (`id_profesor`, `profesion`, `id_persona`, `id_adm`)
VALUES (707, 'ING. SIS', 7654321, 1);

INSERT INTO `u_calle`.`Profesor`
              (`id_profesor`, `profesion`, `id_persona`, `id_adm`)
VALUES (523, 'ING. SIS', 3423726, 1);

INSERT INTO `u_calle`.`Profesor`
              (`id_profesor`, `profesion`, `id_persona`, `id_adm`)
VALUES (351, 'ING. IND', 2345437, 1);
